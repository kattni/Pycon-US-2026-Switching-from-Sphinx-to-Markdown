# Pycon US 2026 Switching from Sphinx to Markdown

Slides and links for my PyCon US 2026 talk Switching from Sphinx to Markdown.

Links to various tools and projects mentioned in the talk, in order of appearance:
...
- [Translate Toolkit](https://docs.translatehouse.org/projects/translate-toolkit/en/latest/index.html)
...
- [BeeWare Docs Tools](https://github.com/beeware/beeware-docs-tools)
- [BeeWare Tutorial](https://tutorial.beeware.org/)
- [Toga documentation](https://toga.beeware.org/)
- [Briefcase documentation](https://briefcase.beeware.org/)
